...
public class Map {
    ...
    ///<summary>Devuelve todas las entidades de las regiones a distancia viewDistance de origin</summary>
    ...
    public void Remove (LivingEntity e, Coord coord) {
        ...
        //Es para que no salga un indice de -1 que no creo que deba de salir
        lastElementIndex = lastElementIndex < 0 ? 0 : lastElementIndex;
        //Debug.Log("index: " + index);
        //Debug.Log("lastElementIndex: " + lastElementIndex);
    ...
    //Da problemas cuando intenta llamar a esta funcion
    public void Move (LivingEntity e, Coord fromCoord, Coord toCoord) {
        Remove (e, fromCoord);
        Add (e, toCoord);
    }

    ///<summary>Coordenadas y distancia a la esquina mas cercana de la region</summary>
