...
namespace TerrainGeneration {
    ...
    public class TerrainGenerator : MonoBehaviour {
        ...
        //En true, genera automaticamente el terreno si se cambia algun valor
        public bool autoUpdate = true;
        //En true, el centro del mapa es el origen, en false, la esquina inferior izquierda es el origen
        ...
        public TerrainData Generate () {
            ...
            for (int y = 0; y < numTilesPerLine; y++) {
                for (int x = 0; x < numTilesPerLine; x++) {
                    ...
                    //Vertices del cuadrado, asi para que se formen siempre cuadrados
                    ...
                    if (isLandTile || isEdgeTile) {
                        //Recorremos todos los posibles vecinos
                        for (int i = 0; i < nswe.Length; i++) {
                            ...
                            if (!neighbourIsOutOfBounds) {
                                ...
                                //Si somos vecinos de agua
                                if (neighbourIsWater) {
                                    terrainData.shore[neighbourX, neighbourY] = true;
                                }
                            }

                            //Para el cuadrado de las casillas vecinas de agua y las del fin del mapa?¿?¿ Para que se dibujen bien?
        ...
        Vector2 GetBiomeInfo (float height, Biome[] biomes) {
            ...
            //Normalizamos la altura height entre [biomeStartHeight, biome.height]
        ...
        //Se llama cuando se modifica un valor en el inspector
        void OnValidate () {
            needsUpdate = true;
        }
        ...
        public class Biome {
            ...
            public Color endCol;
            public int numSteps;//Numero de pasos para el gradiente del color
        }

        ///<summary>Datos del mapa. Su tamaño y numero de tiles andables</summary>
